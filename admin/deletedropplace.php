                        ...
                        <div class="col-md-10">
                            ...
                            <form method="post" >
                                <div class="container card border-0 shadow" style="color:#064663;">
                                    ...
                                    <input type="text" style="border-radius:50px;" placeholder="Enter name of the place" name="drop_place" value="<?php echo $n; ?> " required>
                                    <center>
                                        <button type="submit" class="btn" name="btn_delete" style="background-color:#064663;color:white;">Delete</button>
                                        <a  href="viewdropplace.php" class="btn" style="background-color:#064663;color:white;">Cancel</a>
                                    </center>
                                </div>
                            </form>
                        </div>
